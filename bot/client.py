...
from bot.cogs.spam import SpamCog, SpamProtection
...
class DiscordBot(discord.Client):
    ...
    async def setup_hook(self) -> None:
        ...
        self.load_cog(
            SpamCog(self.config, self, self.spam_protection, self.spam_full_log)
        )
...
def create_bot(
    ...
    return DiscordBot(config, spam_protection, spam_full_log)
